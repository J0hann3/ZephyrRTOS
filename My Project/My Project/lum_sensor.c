...
static light_measure light = {.light = &current_measure.brightness,
							.state = LIGHT_SENSOR_TURN_ON};

static void turn_on_light_sensor();
static void turn_off_light_sensor();
static void light_sensor_write_command();
static void read_lum_sensor();
